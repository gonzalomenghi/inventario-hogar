...
const styles = StyleSheet.create({
  ...
  preview: { width: '100%', height: 220, borderRadius: 12, marginBottom: 12, backgroundColor: '#F3F4F6' },
  previewPdf: {
    padding: 20,
    borderRadius: 12,
    marginBottom: 12,
  ...
  error: { color: '#E5484D', textAlign: 'center', marginVertical: 8 },
  boton: {
  ...
  link: { textAlign: 'center', color: '#208AEF', marginTop: 12 },
});
